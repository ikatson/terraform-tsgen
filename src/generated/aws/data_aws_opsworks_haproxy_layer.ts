...
export interface _data_aws_opsworks_haproxy_layer__ebs_volume {
    iops?: rnumber
    mount_point: rstring
...
export interface data_aws_opsworks_haproxy_layer_config {
    ...
    ebs_volume?: _data_aws_opsworks_haproxy_layer__ebs_volume[]
...
export class data_aws_opsworks_haproxy_layer implements Data {
    config: data_aws_opsworks_haproxy_layer_config
    private _is_data: boolean = true
    private _name: string = "data_aws_opsworks_haproxy_layer"
    private _id: string;
    constructor(id: string, config: data_aws_opsworks_haproxy_layer_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_ebs_volume(): Reference<_data_aws_opsworks_haproxy_layer__ebs_volume[]> {
    ...
    get ref_healthcheck_method(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.healthcheck_method`)
  }
    get ref_healthcheck_url(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.healthcheck_url`)
  }
    ...
    get ref_stats_enabled(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.stats_enabled`)
  }
    get ref_stats_password(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.stats_password`)
  }
    get ref_stats_url(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.stats_url`)
  }
    get ref_stats_user(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.stats_user`)
  }
