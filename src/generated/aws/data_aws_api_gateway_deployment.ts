...
export interface data_aws_api_gateway_deployment_config {
...
export class data_aws_api_gateway_deployment implements Data {
    config: data_aws_api_gateway_deployment_config
    private _is_data: boolean = true
    private _name: string = "data_aws_api_gateway_deployment"
    private _id: string;
    constructor(id: string, config: data_aws_api_gateway_deployment_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_stage_description(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.stage_description`)
  }
