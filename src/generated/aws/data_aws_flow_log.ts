...
export interface data_aws_flow_log_config {
    eni_id?: rstring
...
export class data_aws_flow_log implements Data {
    config: data_aws_flow_log_config
    private _is_data: boolean = true
    private _name: string = "data_aws_flow_log"
    private _id: string;
    constructor(id: string, config: data_aws_flow_log_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_eni_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.eni_id`)
  }
    ...
    get ref_log_destination(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.log_destination`)
  }
    get ref_log_destination_type(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.log_destination_type`)
  }
    ...
    get ref_traffic_type(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.traffic_type`)
  }
