...
export interface data_aws_rds_cluster_instance_config {
...
export class data_aws_rds_cluster_instance implements Data {
    config: data_aws_rds_cluster_instance_config
    private _is_data: boolean = true
    private _name: string = "data_aws_rds_cluster_instance"
    private _id: string;
    constructor(id: string, config: data_aws_rds_cluster_instance_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_copy_tags_to_snapshot(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.copy_tags_to_snapshot`)
  }
    get ref_db_parameter_group_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.db_parameter_group_name`)
  }
    ...
    get ref_performance_insights_enabled(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.performance_insights_enabled`)
  }
    get ref_performance_insights_kms_key_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.performance_insights_kms_key_id`)
  }
