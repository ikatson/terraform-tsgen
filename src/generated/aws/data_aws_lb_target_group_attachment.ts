...
export interface data_aws_lb_target_group_attachment_config {
...
export class data_aws_lb_target_group_attachment implements Data {
    config: data_aws_lb_target_group_attachment_config
    private _is_data: boolean = true
    private _name: string = "data_aws_lb_target_group_attachment"
    private _id: string;
    constructor(id: string, config: data_aws_lb_target_group_attachment_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
