...
export interface data_aws_default_vpc_config {
    arn?: rstring
...
export class data_aws_default_vpc implements Data {
    config: data_aws_default_vpc_config
    private _is_data: boolean = true
    private _name: string = "data_aws_default_vpc"
    private _id: string;
    constructor(id: string, config: data_aws_default_vpc_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_assign_generated_ipv6_cidr_block(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.assign_generated_ipv6_cidr_block`)
  }
    ...
    get ref_default_security_group_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.default_security_group_id`)
  }
    ...
    get ref_enable_classiclink(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.enable_classiclink`)
  }
    get ref_enable_classiclink_dns_support(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.enable_classiclink_dns_support`)
  }
