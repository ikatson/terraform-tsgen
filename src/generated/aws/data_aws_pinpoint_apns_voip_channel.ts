...
export interface data_aws_pinpoint_apns_voip_channel_config {
...
export class data_aws_pinpoint_apns_voip_channel implements Data {
    config: data_aws_pinpoint_apns_voip_channel_config
    private _is_data: boolean = true
    private _name: string = "data_aws_pinpoint_apns_voip_channel"
    private _id: string;
    constructor(id: string, config: data_aws_pinpoint_apns_voip_channel_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
