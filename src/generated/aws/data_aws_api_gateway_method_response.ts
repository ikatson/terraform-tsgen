...
export interface data_aws_api_gateway_method_response_config {
    http_method: rstring
    resource_id: rstring
...
export class data_aws_api_gateway_method_response implements Data {
    config: data_aws_api_gateway_method_response_config
    private _is_data: boolean = true
    private _name: string = "data_aws_api_gateway_method_response"
    private _id: string;
    constructor(id: string, config: data_aws_api_gateway_method_response_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_response_models(): Reference<{[propName: string]: rstring}> {
        return new Reference(`data.${this._name}.${this._id}.response_models`)
  }
