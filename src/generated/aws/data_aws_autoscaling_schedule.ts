...
export interface data_aws_autoscaling_schedule_config {
    arn?: rstring
...
export class data_aws_autoscaling_schedule implements Data {
    config: data_aws_autoscaling_schedule_config
    private _is_data: boolean = true
    private _name: string = "data_aws_autoscaling_schedule"
    private _id: string;
    constructor(id: string, config: data_aws_autoscaling_schedule_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_recurrence(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.recurrence`)
  }
    get ref_scheduled_action_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.scheduled_action_name`)
  }
