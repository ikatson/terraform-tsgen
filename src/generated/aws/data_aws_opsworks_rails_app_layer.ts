...
export interface _data_aws_opsworks_rails_app_layer__ebs_volume {
    iops?: rnumber
    mount_point: rstring
...
export interface data_aws_opsworks_rails_app_layer_config {
    app_server?: rstring
    ...
    ebs_volume?: _data_aws_opsworks_rails_app_layer__ebs_volume[]
...
export class data_aws_opsworks_rails_app_layer implements Data {
    config: data_aws_opsworks_rails_app_layer_config
    private _is_data: boolean = true
    private _name: string = "data_aws_opsworks_rails_app_layer"
    private _id: string;
    constructor(id: string, config: data_aws_opsworks_rails_app_layer_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_app_server(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.app_server`)
  }
    ...
    get ref_bundler_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.bundler_version`)
  }
    ...
    get ref_ebs_volume(): Reference<_data_aws_opsworks_rails_app_layer__ebs_volume[]> {
    ...
    get ref_manage_bundler(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.manage_bundler`)
  }
    get ref_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.name`)
  }
    get ref_passenger_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.passenger_version`)
  }
    get ref_ruby_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.ruby_version`)
  }
    get ref_rubygems_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.rubygems_version`)
  }
