...
export interface data_aws_route53_health_check_config {
...
export class data_aws_route53_health_check implements Data {
    config: data_aws_route53_health_check_config
    private _is_data: boolean = true
    private _name: string = "data_aws_route53_health_check"
    private _id: string;
    constructor(id: string, config: data_aws_route53_health_check_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_child_health_threshold(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.child_health_threshold`)
  }
    get ref_child_healthchecks(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.child_healthchecks`)
  }
    get ref_cloudwatch_alarm_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.cloudwatch_alarm_name`)
  }
    get ref_cloudwatch_alarm_region(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.cloudwatch_alarm_region`)
  }
    get ref_enable_sni(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.enable_sni`)
  }
    get ref_failure_threshold(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.failure_threshold`)
  }
    ...
    get ref_insufficient_data_health_status(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.insufficient_data_health_status`)
  }
    get ref_invert_healthcheck(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.invert_healthcheck`)
  }
    ...
    get ref_measure_latency(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.measure_latency`)
  }
    get ref_port(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.port`)
  }
    get ref_reference_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.reference_name`)
  }
    ...
    get ref_request_interval(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.request_interval`)
  }
    get ref_resource_path(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.resource_path`)
  }
    get ref_search_string(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.search_string`)
  }
