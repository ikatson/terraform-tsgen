...
export interface data_aws_cognito_user_pool_client_config {
...
export class data_aws_cognito_user_pool_client implements Data {
    config: data_aws_cognito_user_pool_client_config
    private _is_data: boolean = true
    private _name: string = "data_aws_cognito_user_pool_client"
    private _id: string;
    constructor(id: string, config: data_aws_cognito_user_pool_client_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_allowed_oauth_flows(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.allowed_oauth_flows`)
  }
    get ref_allowed_oauth_flows_user_pool_client(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.allowed_oauth_flows_user_pool_client`)
  }
    get ref_allowed_oauth_scopes(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.allowed_oauth_scopes`)
  }
    get ref_callback_urls(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.callback_urls`)
  }
    ...
    get ref_default_redirect_uri(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.default_redirect_uri`)
  }
    get ref_explicit_auth_flows(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.explicit_auth_flows`)
  }
    get ref_generate_secret(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.generate_secret`)
  }
    get ref_logout_urls(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.logout_urls`)
  }
    get ref_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.name`)
  }
    get ref_read_attributes(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.read_attributes`)
  }
    get ref_refresh_token_validity(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.refresh_token_validity`)
  }
    get ref_supported_identity_providers(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.supported_identity_providers`)
  }
    ...
    get ref_write_attributes(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.write_attributes`)
  }
}
