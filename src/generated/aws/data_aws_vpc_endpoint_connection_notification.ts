...
export interface data_aws_vpc_endpoint_connection_notification_config {
...
export class data_aws_vpc_endpoint_connection_notification implements Data {
    config: data_aws_vpc_endpoint_connection_notification_config
    private _is_data: boolean = true
    private _name: string = "data_aws_vpc_endpoint_connection_notification"
    private _id: string;
    constructor(id: string, config: data_aws_vpc_endpoint_connection_notification_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_connection_events(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.connection_events`)
  }
    get ref_connection_notification_arn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.connection_notification_arn`)
  }
