...
export interface _data_aws_storagegateway_nfs_file_share__nfs_file_share_defaults {
...
export interface data_aws_storagegateway_nfs_file_share_config {
    arn?: rstring
    client_list: rstring[]
    ...
    nfs_file_share_defaults?: _data_aws_storagegateway_nfs_file_share__nfs_file_share_defaults[]
    object_acl?: rstring
    read_only?: rboolean
...
export class data_aws_storagegateway_nfs_file_share implements Data {
    config: data_aws_storagegateway_nfs_file_share_config
    private _is_data: boolean = true
    private _name: string = "data_aws_storagegateway_nfs_file_share"
    private _id: string;
    constructor(id: string, config: data_aws_storagegateway_nfs_file_share_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_client_list(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.client_list`)
  }
    ...
    get ref_nfs_file_share_defaults(): Reference<_data_aws_storagegateway_nfs_file_share__nfs_file_share_defaults[]> {
        return new Reference(`data.${this._name}.${this._id}.nfs_file_share_defaults`)
  }
    ...
    get ref_squash(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.squash`)
  }
}
