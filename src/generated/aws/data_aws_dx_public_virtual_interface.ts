...
export interface data_aws_dx_public_virtual_interface_config {
...
export class data_aws_dx_public_virtual_interface implements Data {
    config: data_aws_dx_public_virtual_interface_config
    private _is_data: boolean = true
    private _name: string = "data_aws_dx_public_virtual_interface"
    private _id: string;
    constructor(id: string, config: data_aws_dx_public_virtual_interface_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
