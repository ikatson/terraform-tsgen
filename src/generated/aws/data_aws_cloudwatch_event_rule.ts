...
export interface data_aws_cloudwatch_event_rule_config {
    arn?: rstring
    description?: rstring
...
export class data_aws_cloudwatch_event_rule implements Data {
    config: data_aws_cloudwatch_event_rule_config
    private _is_data: boolean = true
    private _name: string = "data_aws_cloudwatch_event_rule"
    private _id: string;
    constructor(id: string, config: data_aws_cloudwatch_event_rule_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_event_pattern(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.event_pattern`)
  }
