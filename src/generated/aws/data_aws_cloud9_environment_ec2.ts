...
export interface data_aws_cloud9_environment_ec2_config {
    arn?: rstring
...
export class data_aws_cloud9_environment_ec2 implements Data {
    config: data_aws_cloud9_environment_ec2_config
    private _is_data: boolean = true
    private _name: string = "data_aws_cloud9_environment_ec2"
    private _id: string;
    constructor(id: string, config: data_aws_cloud9_environment_ec2_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_automatic_stop_time_minutes(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.automatic_stop_time_minutes`)
  }
    ...
    get ref_owner_arn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.owner_arn`)
  }
