...
export interface data_aws_lambda_layer_version_config {
    arn?: rstring
...
export class data_aws_lambda_layer_version implements Data {
    config: data_aws_lambda_layer_version_config
    private _is_data: boolean = true
    private _name: string = "data_aws_lambda_layer_version"
    private _id: string;
    constructor(id: string, config: data_aws_lambda_layer_version_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_compatible_runtimes(): Reference<rstring[]> {
        return new Reference(`data.${this._name}.${this._id}.compatible_runtimes`)
  }
    ...
    get ref_layer_arn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.layer_arn`)
  }
    get ref_layer_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.layer_name`)
  }
    get ref_license_info(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.license_info`)
  }
    get ref_s3_bucket(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.s3_bucket`)
  }
    get ref_s3_key(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.s3_key`)
  }
    get ref_s3_object_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.s3_object_version`)
  }
