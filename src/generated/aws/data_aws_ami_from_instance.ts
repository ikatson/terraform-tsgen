...
export interface _data_aws_ami_from_instance__ebs_block_device {
...
export interface _data_aws_ami_from_instance__ephemeral_block_device {
    device_name?: rstring
    virtual_name?: rstring
}

export interface data_aws_ami_from_instance_config {
    architecture?: rstring
    description?: rstring
    ebs_block_device?: _data_aws_ami_from_instance__ebs_block_device[]
    ena_support?: rboolean
    ephemeral_block_device?: _data_aws_ami_from_instance__ephemeral_block_device[]
...
export class data_aws_ami_from_instance implements Data {
    config: data_aws_ami_from_instance_config
    private _is_data: boolean = true
    private _name: string = "data_aws_ami_from_instance"
    private _id: string;
    constructor(id: string, config: data_aws_ami_from_instance_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_ebs_block_device(): Reference<_data_aws_ami_from_instance__ebs_block_device[]> {
    ...
    get ref_ephemeral_block_device(): Reference<_data_aws_ami_from_instance__ephemeral_block_device[]> {
    ...
    get ref_snapshot_without_reboot(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.snapshot_without_reboot`)
  }
    get ref_source_instance_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.source_instance_id`)
  }
