...
export interface _data_aws_opsworks_java_app_layer__ebs_volume {
    iops?: rnumber
    mount_point: rstring
...
export interface data_aws_opsworks_java_app_layer_config {
    app_server?: rstring
    ...
    ebs_volume?: _data_aws_opsworks_java_app_layer__ebs_volume[]
...
export class data_aws_opsworks_java_app_layer implements Data {
    config: data_aws_opsworks_java_app_layer_config
    private _is_data: boolean = true
    private _name: string = "data_aws_opsworks_java_app_layer"
    private _id: string;
    constructor(id: string, config: data_aws_opsworks_java_app_layer_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_app_server_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.app_server_version`)
  }
    ...
    get ref_ebs_volume(): Reference<_data_aws_opsworks_java_app_layer__ebs_volume[]> {
    ...
    get ref_jvm_options(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.jvm_options`)
  }
    get ref_jvm_type(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.jvm_type`)
  }
    get ref_jvm_version(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.jvm_version`)
  }
