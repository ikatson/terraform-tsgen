...
export interface data_aws_docdb_cluster_snapshot_config {
...
export class data_aws_docdb_cluster_snapshot implements Data {
    config: data_aws_docdb_cluster_snapshot_config
    private _is_data: boolean = true
    private _name: string = "data_aws_docdb_cluster_snapshot"
    private _id: string;
    constructor(id: string, config: data_aws_docdb_cluster_snapshot_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
