...
export interface data_aws_ec2_transit_gateway_route_table_propagation_config {
    resource_id?: rstring
...
export class data_aws_ec2_transit_gateway_route_table_propagation implements Data {
    config: data_aws_ec2_transit_gateway_route_table_propagation_config
    private _is_data: boolean = true
    private _name: string = "data_aws_ec2_transit_gateway_route_table_propagation"
    private _id: string;
    constructor(id: string, config: data_aws_ec2_transit_gateway_route_table_propagation_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
