...
export interface _data_aws_vpn_connection__routes {
    destination_cidr_block?: rstring
    source?: rstring
    state?: rstring
}

export interface _data_aws_vpn_connection__vgw_telemetry {
...
export interface data_aws_vpn_connection_config {
    customer_gateway_configuration?: rstring
    customer_gateway_id: rstring
    routes?: _data_aws_vpn_connection__routes[]
    ...
    type: rstring
    vgw_telemetry?: _data_aws_vpn_connection__vgw_telemetry[]
    vpn_gateway_id?: rstring
}

export class data_aws_vpn_connection implements Data {
    config: data_aws_vpn_connection_config
    private _is_data: boolean = true
    private _name: string = "data_aws_vpn_connection"
    private _id: string;
    constructor(id: string, config: data_aws_vpn_connection_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_customer_gateway_configuration(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.customer_gateway_configuration`)
  }
    get ref_customer_gateway_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.customer_gateway_id`)
  }
    get ref_routes(): Reference<_data_aws_vpn_connection__routes[]> {
        return new Reference(`data.${this._name}.${this._id}.routes`)
  }
    get ref_static_routes_only(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.static_routes_only`)
  }
    ...
    get ref_tunnel1_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_address`)
  }
    get ref_tunnel1_bgp_asn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_bgp_asn`)
  }
    get ref_tunnel1_bgp_holdtime(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_bgp_holdtime`)
  }
    get ref_tunnel1_cgw_inside_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_cgw_inside_address`)
  }
    get ref_tunnel1_inside_cidr(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_inside_cidr`)
  }
    get ref_tunnel1_preshared_key(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_preshared_key`)
  }
    get ref_tunnel1_vgw_inside_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel1_vgw_inside_address`)
  }
    get ref_tunnel2_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_address`)
  }
    get ref_tunnel2_bgp_asn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_bgp_asn`)
  }
    get ref_tunnel2_bgp_holdtime(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_bgp_holdtime`)
  }
    get ref_tunnel2_cgw_inside_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_cgw_inside_address`)
  }
    get ref_tunnel2_inside_cidr(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_inside_cidr`)
  }
    get ref_tunnel2_preshared_key(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_preshared_key`)
  }
    get ref_tunnel2_vgw_inside_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.tunnel2_vgw_inside_address`)
  }
    get ref_type(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.type`)
  }
    get ref_vgw_telemetry(): Reference<_data_aws_vpn_connection__vgw_telemetry[]> {
        return new Reference(`data.${this._name}.${this._id}.vgw_telemetry`)
  }
