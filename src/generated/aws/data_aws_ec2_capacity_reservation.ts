...
export interface data_aws_ec2_capacity_reservation_config {
...
export class data_aws_ec2_capacity_reservation implements Data {
    config: data_aws_ec2_capacity_reservation_config
    private _is_data: boolean = true
    private _name: string = "data_aws_ec2_capacity_reservation"
    private _id: string;
    constructor(id: string, config: data_aws_ec2_capacity_reservation_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_end_date_type(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.end_date_type`)
  }
    get ref_ephemeral_storage(): Reference<boolean> {
        return new Reference(`data.${this._name}.${this._id}.ephemeral_storage`)
  }
    ...
    get ref_instance_match_criteria(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.instance_match_criteria`)
  }
    get ref_instance_platform(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.instance_platform`)
  }
