...
export interface data_aws_default_subnet_config {
    arn?: rstring
...
export class data_aws_default_subnet implements Data {
    config: data_aws_default_subnet_config
    private _is_data: boolean = true
    private _name: string = "data_aws_default_subnet"
    private _id: string;
    constructor(id: string, config: data_aws_default_subnet_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
