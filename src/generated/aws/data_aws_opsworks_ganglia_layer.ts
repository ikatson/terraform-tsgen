...
export interface _data_aws_opsworks_ganglia_layer__ebs_volume {
    iops?: rnumber
    mount_point: rstring
...
export interface data_aws_opsworks_ganglia_layer_config {
    ...
    ebs_volume?: _data_aws_opsworks_ganglia_layer__ebs_volume[]
...
export class data_aws_opsworks_ganglia_layer implements Data {
    config: data_aws_opsworks_ganglia_layer_config
    private _is_data: boolean = true
    private _name: string = "data_aws_opsworks_ganglia_layer"
    private _id: string;
    constructor(id: string, config: data_aws_opsworks_ganglia_layer_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_ebs_volume(): Reference<_data_aws_opsworks_ganglia_layer__ebs_volume[]> {
