...
export interface data_aws_cloudhsm_v2_hsm_config {
...
export class data_aws_cloudhsm_v2_hsm implements Data {
    config: data_aws_cloudhsm_v2_hsm_config
    private _is_data: boolean = true
    private _name: string = "data_aws_cloudhsm_v2_hsm"
    private _id: string;
    constructor(id: string, config: data_aws_cloudhsm_v2_hsm_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_hsm_eni_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.hsm_eni_id`)
  }
    get ref_hsm_id(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.hsm_id`)
  }
    get ref_hsm_state(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.hsm_state`)
  }
