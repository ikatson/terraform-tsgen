...
export interface data_aws_s3_bucket_public_access_block_config {
...
export class data_aws_s3_bucket_public_access_block implements Data {
    config: data_aws_s3_bucket_public_access_block_config
    private _is_data: boolean = true
    private _name: string = "data_aws_s3_bucket_public_access_block"
    private _id: string;
    constructor(id: string, config: data_aws_s3_bucket_public_access_block_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
