...
export interface data_aws_neptune_cluster_config {
...
export class data_aws_neptune_cluster implements Data {
    config: data_aws_neptune_cluster_config
    private _is_data: boolean = true
    private _name: string = "data_aws_neptune_cluster"
    private _id: string;
    constructor(id: string, config: data_aws_neptune_cluster_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_neptune_cluster_parameter_group_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.neptune_cluster_parameter_group_name`)
  }
