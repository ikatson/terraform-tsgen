...
export interface data_aws_lambda_event_source_mapping_config {
    batch_size?: rnumber
    enabled?: rboolean
...
export class data_aws_lambda_event_source_mapping implements Data {
    config: data_aws_lambda_event_source_mapping_config
    private _is_data: boolean = true
    private _name: string = "data_aws_lambda_event_source_mapping"
    private _id: string;
    constructor(id: string, config: data_aws_lambda_event_source_mapping_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_batch_size(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.batch_size`)
  }
    ...
    get ref_event_source_arn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.event_source_arn`)
  }
    get ref_function_arn(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.function_arn`)
  }
    ...
    get ref_last_processing_result(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.last_processing_result`)
  }
    get ref_starting_position(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.starting_position`)
  }
    get ref_starting_position_timestamp(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.starting_position_timestamp`)
  }
    ...
    get ref_state_transition_reason(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.state_transition_reason`)
  }
    get ref_uuid(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.uuid`)
  }
}
