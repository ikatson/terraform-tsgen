...
export interface data_aws_cloudfront_public_key_config {
...
export class data_aws_cloudfront_public_key implements Data {
    config: data_aws_cloudfront_public_key_config
    private _is_data: boolean = true
    private _name: string = "data_aws_cloudfront_public_key"
    private _id: string;
    constructor(id: string, config: data_aws_cloudfront_public_key_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_encoded_key(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.encoded_key`)
  }
