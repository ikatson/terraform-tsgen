...
export interface data_aws_neptune_cluster_instance_config {
    address?: rstring
...
export class data_aws_neptune_cluster_instance implements Data {
    config: data_aws_neptune_cluster_instance_config
    private _is_data: boolean = true
    private _name: string = "data_aws_neptune_cluster_instance"
    private _id: string;
    constructor(id: string, config: data_aws_neptune_cluster_instance_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_neptune_parameter_group_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.neptune_parameter_group_name`)
  }
    get ref_neptune_subnet_group_name(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.neptune_subnet_group_name`)
  }
