...
export interface data_aws_db_event_subscription_config {
    arn?: rstring
...
export class data_aws_db_event_subscription implements Data {
    config: data_aws_db_event_subscription_config
    private _is_data: boolean = true
    private _name: string = "data_aws_db_event_subscription"
    private _id: string;
    constructor(id: string, config: data_aws_db_event_subscription_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_sns_topic(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.sns_topic`)
  }
