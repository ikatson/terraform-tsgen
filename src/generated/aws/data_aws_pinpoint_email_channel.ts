...
export interface data_aws_pinpoint_email_channel_config {
...
export class data_aws_pinpoint_email_channel implements Data {
    config: data_aws_pinpoint_email_channel_config
    private _is_data: boolean = true
    private _name: string = "data_aws_pinpoint_email_channel"
    private _id: string;
    constructor(id: string, config: data_aws_pinpoint_email_channel_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
    ...
    get ref_from_address(): Reference<string> {
        return new Reference(`data.${this._name}.${this._id}.from_address`)
  }
    ...
    get ref_messages_per_second(): Reference<number> {
        return new Reference(`data.${this._name}.${this._id}.messages_per_second`)
  }
