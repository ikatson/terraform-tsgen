...
export interface data_aws_iam_role_policy_config {
    name?: rstring
    name_prefix?: rstring
    policy: rstring
    role: rstring
...
export class data_aws_iam_role_policy implements Data {
    config: data_aws_iam_role_policy_config
    private _is_data: boolean = true
    private _name: string = "data_aws_iam_role_policy"
    private _id: string;
    constructor(id: string, config: data_aws_iam_role_policy_config) {
        this._id = id;
        this.config = config;
    }
    getID(): string {
